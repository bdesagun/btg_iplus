                                                ...
                                                <table width="95%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
															<p>I confirm that:</p>
															<ol>
																<li style="padding: 10px">I am authorised to provide this information on behalf of <b>{clientname} - {entityname}</b>.</li>
																<li style="padding: 10px">All relevant data has been uploaded for the BAS period.</li>
																<li style="padding: 10px">To the best of my knowledge, the data is complete and accurate.</li>
															</ol>
															<br>
															<p><b>{accountname}</b></p>
															<center>
