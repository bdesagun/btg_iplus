...
def send_email_fp(sender,recipient,subject,password,username,userpass,loginlink):
    try:
                                                ...
                                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
                                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Hi, User
                                                            </h1>
                                                            <p>This is your default password for your account. Please change your password as soon as possible.</p>
                                                            <hr>
...
if __name__ == '__main__':
    ...
    parser.add_argument('-un',dest='username',type=str,help="Enter Username")
    parser.add_argument('-up',dest='userpass',type=str,help="Enter Password")
    ...
    send_email_fp(sender,recipient,subject,password,username,userpass,loginlink)
