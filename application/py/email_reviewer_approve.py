...
def send_email_fp(sender,recipient,subject,password,basmonth,basyear,clientname,entityname,loginlink):
    try:
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
															...
															<p style="line-height: 30px">
																Good news. The <b>{basmonth} - {basyear}</b> BAS for <b>{clientname} / {entityname}</b> is ready for your approval. Once approved, we will lodge the BAS immediately.
															</p>
															<br>
															<p>
																Regards
...
if __name__ == '__main__':
    ...
    parser.add_argument('-bm',dest='basmonth',type=str,help="Enter Month")
    parser.add_argument('-by',dest='basyear',type=str,help="Enter Year")
    ...
    basmonth = args.basmonth
    basyear = args.basyear
    ...
    send_email_fp(sender,recipient,subject,password,basmonth,basyear,clientname,entityname,loginlink)
