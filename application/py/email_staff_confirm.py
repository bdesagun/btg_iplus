...
def send_email_fp(sender,recipient,subject,password,clientname,entityname,loginlink):
    try:
                                                ...
                                                <table width="95%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
															...
															<br>
															<p>
																The BAS for <b>{clientname} / {entityname}</b> is ready for your review and sign-off.
															</p>
															<br>
															<p>
																Regards
...
if __name__ == '__main__':
    ...
    send_email_fp(sender,recipient,subject,password,clientname,entityname,loginlink)
