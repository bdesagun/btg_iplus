                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 d-inline-block mb-0">SOURCE DATA</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid mt--6">
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        <!-- Card header -->
                        <div class="table-responsive py-4"  id="div_sourcedata_table"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loadBashistory(){
        $("#div_sourcedata_table").html("<img src='<?php echo base_url(); ?>assets/img/brand/loading.gif'>");
        params = {
        ...
        $.post("select_filezone", params).done(function(data) {
            $("#div_sourcedata_table").html(data);
        });
    }
    function GetMonth(){
